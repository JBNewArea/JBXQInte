...
<div class="path_nav">
    当前位置： <a href="${adminPath}/onlinerep/index">首页 > </a>
    		 ...
    		 <c:if test="${type == 1}">
    		 	 <a href="${adminPath}/onlinerep/themeMatter">网上办事 > </a>
    		 </c:if>
        ...
        <div class="sx_info">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td style="width: 720px;" id="trans_name"></td>
                </tr>
                <tr>
                    <td style="width: 160px;">办理部门</td>
                    <td style="width: 720px;" id="office_name"></td>
                </tr>
                <tr>
...
<html:js name="online_rep_405,online_rep_common,online_rep_bs_banli,online_rep_bs_filedownloadView"/>
