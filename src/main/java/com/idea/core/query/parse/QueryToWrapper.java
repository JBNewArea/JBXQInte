package com.idea.core.query.parse;
...
import com.idea.core.query.data.Condition;
import com.idea.core.query.data.Condition.Filter;
import com.idea.core.query.data.Condition.Operator;
import com.idea.core.query.data.Queryable;
import com.idea.core.utils.ObjectUtils;
...
public class QueryToWrapper<T> {
	...
	public void parseSort(Wrapper<T> wrapper, Queryable queryable) {
		com.idea.core.query.data.Sort sort = queryable.getPageable().getSort();
		if (sort != null) {
			for (com.idea.core.query.data.Sort.Order order : sort) {
				if (order.getDirection() == com.idea.core.query.data.Sort.Direction.DESC) {
					wrapper.orderBy(order.getProperty(), false);
				} else if (order.getDirection() == com.idea.core.query.data.Sort.Direction.ASC) {
